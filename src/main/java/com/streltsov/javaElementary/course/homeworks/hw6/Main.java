...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        DynamicList listDog = new DynamicArray();
        DynamicList listCat = new DynamicArray();
        ...
        listDog.addAll(listCat); // addAll method
        ...
        DynamicList subList = listDog.sublist(5); // sublist method from i

        DynamicList partList = listDog.sublist(2,7); // sublist method from i to i
